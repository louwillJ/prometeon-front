(function (factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      helperSelectNamePostfix: false, // 'string_of_postfix' / false
      selectorMinimalHeight: 152,
      ...
      btnRemoveAllText: '<i class="fas fa-angle-double-left"></i>' // string, sets the text for the "Remove All" button
    },
